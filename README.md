...
* The class should define a bean named `delTechTuesdayInstructors()` which returns an `Instructors` representative of the DelTech Tuesday instructors.
* The class should define a bean named `delTechThursdayInstructors()` which returns an `Instructors` representative of the DelTech Thursday instructors.
* The class should define a bean named `instructors` which returns all `Instructors` employed at DelTech
